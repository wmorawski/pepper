...
export class StarshipsFactory extends ResourceCreator {
  ...
  protected readonly commonAttribute = 'crew';
  protected readonly properties = ['model', 'starship_class', 'manufacturer', 'cost_in_credits', 'hyperdrive_rating', 'crew'];
  protected readonly minMaxId: [number, number] = [2, 75];
  protected readonly possibleIds = Array.from({length: 74}, (_, i) => i + 1);
  protected readonly notExistingIds = [4, 6, 7, 8, 14, 16, 18, 19, 20, 24, 25, 26, 30, 33, 34, 35, 36, 37, 38, 42, 44, 45, 46, 50, 51, 53, 54, 55, 56, 57, 60, 62, 67, 69, 70, 71, 72, 73];
